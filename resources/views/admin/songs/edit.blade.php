                ...
                <div class="language-tabs">
                    ...
                    <div class="tab-content active" id="gujarati-tab">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control gujarati-text @error('title_gu') is-invalid @enderror" 
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control gujarati-text content-textarea @error('lyrics_gu') is-invalid @enderror" 
                                id="lyrics_gu" name="lyrics_gu" rows="15" 
                                placeholder="{{ __('વચનામૃતનું મૂળ લખાણ લખો...') }}" 
                                required>{{ old('lyrics_gu', $song->lyrics_gu) }}</textarea>
                            @error('lyrics_gu')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            <small class="form-text text-muted">
