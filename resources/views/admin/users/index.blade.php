...
@section('content')
    <div class="container-fluid">
        ...
        <table id="usersTable" class="display text-center" style="width:100%">
            <thead>
                <tr>
                    <th>{{ __('Name') }}</th>
                    <th>{{ __('Email') }}</th>
...
@section('script')
    <script>
        const btnShow = @json($createBtnShow);
                ...
                $('#usersTable').DataTable({
                    ...
                    columns: [{
                        ...
                        `;
                                if (btnShow == '1') {
                                    actionHtml += `
                                <a href="/admin/users/${row.id}/edit" class="btn btn-sm btn-warning" data-toggle="tooltip" title="Edit">
