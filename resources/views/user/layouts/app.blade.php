...
<head>
    ...
    <link rel="stylesheet"
        href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:opsz,wght,FILL,GRAD@24,400,0,0&icon_names=format_size" />
    <link rel="stylesheet"
        href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:opsz,wght,FILL,GRAD@20..48,100..700,0..1,-50..200&icon_names=g_translate" />
    <script type="module" src="https://unpkg.com/ionicons@7.1.0/dist/ionicons/ionicons.esm.js"></script>
    <script nomodule src="https://unpkg.com/ionicons@7.1.0/dist/ionicons/ionicons.js"></script>
    <link
        href="https://fonts.googleapis.com/css2?family=Anek+Gujarati:wght@100..800&family=Rasa:ital,wght@0,300..700;1,300..700&display=swap"
        rel="stylesheet">
...
<body>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Setup font controls for both mobile and desktop
            setupFontSizeControls('fontSizeToggleMobile', 'fontSizeControlsMobile', 'increaseFontSizeMobile',
                'decreaseFontSizeMobile');
            setupFontSizeControls('fontSizeToggleDesktop', 'fontSizeControlsDesktop', 'increaseFontSizeDesktop',
                'decreaseFontSizeDesktop');
        });
    </script>
